...
/**
 * Frida0xKit - LogInterceptor - 0x007v - lol
 * 
 * Hooks Android Java and native logging APIs.
 * Prints application logs directly to the Frida console.
 * Supports both android.util.Log and liblog.so logging.
 */
